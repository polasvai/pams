...
public class Player
{
    ...
    [StringLength(60)] public string? Nationality { get; set; }
    public PlayerRole Role { get; set; }
    [StringLength(30)] public string? BattingStyle { get; set; }
    [StringLength(30)] public string? BowlingStyle { get; set; }
...
public class Team
{
    ...
    [Range(0, double.MaxValue)] public decimal TotalBudget { get; set; }
    public ICollection<AuctionPlayer> AuctionPlayers { get; set; } = new List<AuctionPlayer>();
...
public class Auction
{
    ...
    public int? CurrentAuctionPlayerId { get; set; }
    public AuctionPlayer? CurrentAuctionPlayer { get; set; }
    public ICollection<AuctionPlayer> AuctionPlayers { get; set; } = new List<AuctionPlayer>();
}
